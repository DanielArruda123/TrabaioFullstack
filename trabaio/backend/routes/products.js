...
router.post('/', verifyJWT, (req, res) => {
  ...
  if (!nome || !descricao || preco === undefined || estoque === undefined || !categoria || !animal) {
    return res.status(400).send({ error: 'Campos obrigatórios faltando: nome, descricao, preco, estoque, categoria, animal' });
  }
...
router.put('/:id', (req, res) => {
  ...
  // Add validation for required fields
  if (!nome || !descricao || preco === undefined || estoque === undefined || !categoria || !animal) {
    return res.status(400).json({ error: 'Campos obrigatórios faltando: nome, descricao, preco, estoque, categoria, animal' });
  }
